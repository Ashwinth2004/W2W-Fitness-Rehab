    ...
    <div className="container-page max-w-3xl py-14 md:py-20">
      ...
      <Section title="Contact us">
        ...
        <ul className="space-y-2">
          <li><a href={BUSINESS.mapsUrl} target="_blank" rel="noreferrer" className="flex items-start justify-center gap-2 font-medium text-brand-700 hover:underline md:justify-start"><MapPin size={18} className="mt-0.5 shrink-0 text-brand-500" /> {BUSINESS.address}</a></li>

...
export default function AdminPageHeader({ title, subtitle, children }) {
  return (
    <div className="sticky top-16 z-30 -mx-4 -mt-4 mb-1 flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-slate-200 bg-slate-50/95 px-4 py-3 backdrop-blur md:-mx-6 md:-mt-6 md:px-6 lg:-mx-8 lg:-mt-8 lg:top-0 lg:px-8 lg:py-4">

// Exact brand glyphs (official logo paths) for social + call links.
// Lucide doesn't ship a WhatsApp/Instagram brand mark, so we provide them here.
// Each accepts `size` and any standard svg props (className, etc.).
...
// Multi-colour Google "G" mark (used for the Google-reviews styling).
export function GoogleIcon({ size = 24, ...props }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} aria-label="Google" role="img" {...props}>
...
// Solid filled phone (handset) — the universal "call" glyph.
